...
def datosAutor(request):
    aut = {
        'nombre' : 'Edinson Aravena',
        'edad': 21,
        'email': 'edinson.aravena@inacapmail.cl',
...
def agregar_institucion(request):
    ...
    data = {'form' : form}
    return render (request,'seminario/formulario_institucion.html',data)
...
def agregar_participante(request):
    ...
    data = {'form' : form}
    return render (request,'seminario/formulario_participante.html',data)
